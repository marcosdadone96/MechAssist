...
const dict = {
  es: {
    ...
    'pricing.lead':
      'Tres caminos independientes: registro con cr\u00e9ditos de bienvenida, suscripci\u00f3n (9 o 25 \u20ac/mes) o desbloqueo puntual de una calculadora (1 \u20ac/mes, uso ilimitado en esa herramienta).',
    ...
    'pricing.pro.ribbon': 'Starter',
    'pricing.pro.name': 'Starter',
    'pricing.pro.priceBig': '9 \u20ac',
    'pricing.pro.perMonth': '/mes',
    'pricing.pro.annualLine': 'o 79 \u20ac/a\u00f1o \u00b7 Ilimitado 25 \u20ac/mes',
    'pricing.pro.eqLine': 'Hasta 30 PDF/mes en Starter \u00b7 Ilimitado sin cr\u00e9ditos',
    'pricing.pro.tagline': 'Suscripciones mensuales o anuales (independientes del desbloqueo puntual).',
    'pricing.pro.b1': 'Starter 9 \u20ac/mes: cr\u00e9ditos + hasta 30 PDF/mes',
    'pricing.pro.b2': 'Ilimitado 25 \u20ac/mes: todo el cat\u00e1logo sin gastar cr\u00e9ditos',
    'pricing.pro.b3': 'No incluye el desbloqueo puntual (ver columna al lado)',
    'pricing.pro.b4': 'Gestione la suscripci\u00f3n en el portal Lemon',
    'pricing.pro.b5': 'Plan anual Starter con descuento',
    'pricing.pro.b6': 'Precio final e IVA en checkout seg\u00fan pa\u00eds',
    'pricing.pro.cta': 'Suscripciones 9 / 25 \u20ac',
    'pricing.unlock.name': 'Una calculadora',
    'pricing.unlock.priceBig': '1 \u20ac',
    'pricing.unlock.perMonth': '/mes',
  ...
  en: {
    ...
    'pricing.lead':
      'Three independent paths: sign up with welcome credits, subscription (\u20ac9 or \u20ac25/mo), or unlock a single calculator (\u20ac1/mo, unlimited on that tool).',
    ...
    'pricing.pro.annualLine': 'or 79 \u20ac/year \u00b7 Unlimited 25 \u20ac/month',
    'pricing.pro.eqLine': 'Up to 30 PDFs/month on Starter \u00b7 Unlimited skips credits',
    'pricing.pro.tagline': 'Monthly or annual subscriptions (separate from pay-per-calculator).',
    'pricing.pro.b1': 'Starter \u20ac9/mo: credits + up to 30 PDFs/month',
    'pricing.pro.b2': 'Unlimited \u20ac25/mo: full catalog without spending credits',
    'pricing.pro.b3': 'Does not include single-calculator unlock (see next column)',
    'pricing.pro.b4': 'Manage billing in the Lemon portal',
    'pricing.pro.b5': 'Annual Starter plan available',
    'pricing.pro.b6': 'Final price and VAT shown at checkout',
    'pricing.pro.cta': 'Subscriptions \u20ac9 / \u20ac25',
    'pricing.unlock.name': 'One calculator',
    'pricing.unlock.priceBig': '\u20ac1',
    'pricing.unlock.perMonth': '/month',

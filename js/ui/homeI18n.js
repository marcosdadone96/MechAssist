...
const dict = {
  es: {
    ...
    'pricing.lead':
      'Invitado: vea demos con presets. Registrado: 100 cr\u00e9ditos por \u00e1rea (lab, m\u00e1quinas, hidr\u00e1ulica). Cada sesi\u00f3n de c\u00e1lculo (~12 min) y cada PDF: 10 cr\u00e9ditos.',
    ...
    'pricing.pro.eqLine': 'Hasta 30 PDF/mes incluidos \u00b7 desbloqueo calculadora 1 \u20ac/mes',
    'pricing.pro.tagline': 'Para uso recurrente sin agotar cr\u00e9ditos de bienvenida.',
    'pricing.pro.b1': 'Suscripci\u00f3n Starter con cuota de PDF mensual',
    'pricing.pro.b2': 'Plan Ilimitado: c\u00e1lculos y PDF sin consumir cr\u00e9ditos',
    'pricing.pro.b3': 'Desbloquee una calculadora concreta por 1 \u20ac/mes',
    'pricing.pro.b4': 'M\u00f3dulos Pro de m\u00e1quinas con suscripci\u00f3n o desbloqueo',
    'pricing.pro.b5': 'Gestione la suscripci\u00f3n desde el portal Lemon',
    'pricing.pro.b6': 'Precio final e IVA en checkout seg\u00fan pa\u00eds',
    'pricing.pro.cta': 'Ver planes de pago',
    'pricing.footnote':
  ...
  en: {
    ...
    'pricing.lead':
      'Guests: demo presets only. Registered: 100 welcome credits per area (lab, machines, hydraulics). Each calc session (~12 min) and each PDF: 10 credits.',
    ...
    'pricing.pro.eqLine': 'Up to 30 PDFs/month included \u00b7 single-calculator unlock \u20ac1/month',
    'pricing.pro.tagline': 'For recurring use without burning welcome credits.',
    'pricing.pro.b1': 'Starter subscription with monthly PDF allowance',
    'pricing.pro.b2': 'Unlimited plan: calc and PDF without spending credits',
    'pricing.pro.b3': 'Unlock one calculator for \u20ac1/month',
    'pricing.pro.b4': 'Pro machine modules with subscription or unlock',
    'pricing.pro.b5': 'Manage billing in the Lemon customer portal',
    'pricing.pro.b6': 'Final price and VAT shown at checkout',
    'pricing.pro.cta': 'View paid plans',
    'pricing.footnote':

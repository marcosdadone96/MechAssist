/**
 * Sugerencias: 1) función Netlify email-feedback (Resend), 2) Web3Forms si hay clave en runtime
...
/**
 * Envo independiente del hosting (requiere clave en features.js).
 * @param {HTMLFormElement} form
...
/**
 * Netlify Forms: mismo cuerpo en la accin del form y, si falla, en la raz del sitio.
 * @param {HTMLFormElement} form
 */

...
import { TRACTION_ELEVATOR_VALIDATION } from './machineCalcInputValidation.js';
...
function computeAndRenderCore() {
  if (syncInputValidationResultsGate(document.getElementById('teResults'))) return;
...
syncCwManualUi();
syncReevingVisual();
bindInputValidation(TRACTION_ELEVATOR_VALIDATION);

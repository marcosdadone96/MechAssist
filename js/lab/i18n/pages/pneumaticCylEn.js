...
export const PNEUMATIC_CYL_EN = {
  ...
  'pneuCyl.hintCylType': 'Sets active areas and air consumption per cycle',
  'pneuCyl.helpCylType':
  ...
  'pneuCyl.hintCalcMode': 'Switch between design and diagnostic',
  'pneuCyl.helpCalcMode':
    'Diagnostic mode derives real force from installed bore diameter and supply pressure.',
  'pneuCyl.hintMemPdf': 'Expanded memory and PDF',
  'pneuCyl.hintPatm': 'For free-air Nl conversion',
  'pneuCyl.optEuler10': '1.0 \u2014 ideal short supports',
  'pneuCyl.optEuler12': '1.2 \u2014 previous default',
  'pneuCyl.optEuler15': '1.5 \u2014 weak intermediate guides',
  'pneuCyl.optEuler20': '2.0 \u2014 very free rod',
  'pneuCyl.hintMethodNote': 'Shown in memory and PDF',
  'pneuCyl.placeholderMethodNote': 'E.g. ISO 15552, mounting with guides\u2026',
  'pneuCyl.labelDiameterMode': 'Diameter mode',
  'pneuCyl.optIsoMode': 'ISO standard (15552/6432)',
  'pneuCyl.optManualMode': 'Manual',
  'pneuCyl.hintDiameterMode': 'ISO reduces cost and lead time',
  'pneuCyl.helpDiameterMode':
    'ISO mode uses standardized commercial dimensions. Manual mode allows free values with nearest-standard warning.',
  'pneuCyl.hintPressureSupply': 'Gauge supply pressure',
  'pneuCyl.pressureRow1': 'Light automation / packaging',
  'pneuCyl.pressureRow1t': '4 \u2013 6 bar',
  'pneuCyl.pressureRow2': 'General industrial / handling',
  'pneuCyl.pressureRow2t': '6 \u2013 8 bar',
  'pneuCyl.pressureRow3': 'High-force / pressing applications',
  'pneuCyl.pressureRow3t': '8 \u2013 10 bar',
  'pneuCyl.pressureRow4': 'Special systems (high force)',
  'pneuCyl.pressureRow4t': '10 \u2013 16 bar',
  'pneuCyl.hintBore': 'Defines main active area',
  'pneuCyl.hintRod': 'Affects retract force and buckling',
  'pneuCyl.labelBoreManual': 'Manual piston diameter (mm)',
  'pneuCyl.hintBoreManual': 'Only for non-standard case',
  'pneuCyl.helpBoreManual':
    'If value does not match ISO, the advisor suggests the nearest standardized diameter.',
  'pneuCyl.labelRodManual': 'Manual rod diameter (mm)',
  'pneuCyl.hintRodManual': 'Validate commercial availability',
  'pneuCyl.helpRodManual': 'Non-ISO rods may increase cost and delivery time.',
  'pneuCyl.hintStroke': 'Useful displacement length',
  'pneuCyl.hintLoad': 'Equivalent external load',
  'pneuCyl.labelCycles': 'Cycles per minute (cpm)',
  'pneuCyl.hintCycles': 'Operating frequency',
  'pneuCyl.helpCycles':
    'Used to calculate Nl/min consumption for compressor and air storage sizing.',
  'pneuCyl.hintMotion': 'Adjusts safety factor criterion',

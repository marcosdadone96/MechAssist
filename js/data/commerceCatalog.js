...
export const COMMERCE_ITEMS = [
  /* V-belts */
  { id: 'belt-v-SPZ', category: 'belt', label: 'V-belt SPZ · standard pitch length', priceEUR: 12.5, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/spz' },
  { id: 'belt-v-SPA', category: 'belt', label: 'V-belt SPA · standard pitch length', priceEUR: 18.9, stock: '48h', supplierUrl: 'https://example-industrial.example/p/spa' },
  { id: 'belt-v-SPB', category: 'belt', label: 'V-belt SPB · standard pitch length', priceEUR: 28.4, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/spb' },
  { id: 'belt-v-SPC', category: 'belt', label: 'V-belt SPC · standard pitch length', priceEUR: 42.0, stock: '1w', supplierUrl: 'https://example-industrial.example/p/spc' },
  { id: 'belt-v-XPZ', category: 'belt', label: 'V-belt XPZ high capacity', priceEUR: 16.2, stock: '48h', supplierUrl: 'https://example-industrial.example/p/xpz' },
  { id: 'belt-v-XPA', category: 'belt', label: 'V-belt XPA high capacity', priceEUR: 24.5, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/xpa' },
  { id: 'belt-v-XPB', category: 'belt', label: 'V-belt XPB high capacity', priceEUR: 36.0, stock: '48h', supplierUrl: 'https://example-industrial.example/p/xpb' },
  /* Synchronous */
  { id: 'belt-sync-3', category: 'belt', label: 'Synchronous belt · 3M pitch · Lp ≈ 900 mm', priceEUR: 38.0, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/sync-3m' },
  { id: 'belt-sync-5', category: 'belt', label: 'Synchronous belt · 5M pitch · Lp ≈ 1200 mm', priceEUR: 52.0, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/sync-5m' },
  { id: 'belt-sync-8', category: 'belt', label: 'Synchronous belt · 8M pitch · Lp ≈ 1440 mm', priceEUR: 78.0, stock: '48h', supplierUrl: 'https://example-industrial.example/p/sync-8m' },
  { id: 'belt-sync-8_at', category: 'belt', label: 'Synchronous belt AT10 · Lp ≈ 1500 mm', priceEUR: 95.0, stock: '1w', supplierUrl: 'https://example-industrial.example/p/at10' },
  { id: 'belt-sync-14', category: 'belt', label: 'Synchronous belt 14M industrial', priceEUR: 210.0, stock: '1w', supplierUrl: 'https://example-industrial.example/p/14m' },
  { id: 'belt-sync-2.032', category: 'belt', label: 'Synchronous belt XL · 2.032 mm pitch', priceEUR: 29.0, stock: '48h', supplierUrl: 'https://example-industrial.example/p/xl' },
  /* Flat / Poly-V */
  { id: 'belt-flat-std', category: 'belt', label: 'Flat neoprene belt · standard width', priceEUR: 45.0, stock: '48h', supplierUrl: 'https://example-industrial.example/p/flat' },
  { id: 'belt-poly-PJ', category: 'belt', label: 'Poly-V belt PJ', priceEUR: 34.0, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/pj' },
  { id: 'belt-poly-PK', category: 'belt', label: 'Poly-V belt PK', priceEUR: 48.0, stock: 'in_stock', supplierUrl: 'https://example-industrial.example/p/pk' },
  { id: 'belt-poly-PL', category: 'belt', label: 'Poly-V belt PL', priceEUR: 72.0, stock: '48h', supplierUrl: 'https://example-industrial.example/p/pl' },
  { id: 'belt-poly-PM', category: 'belt', label: 'Poly-V belt PM', priceEUR: 118.0, stock: '1w', supplierUrl: 'https://example-industrial.example/p/pm' },
  /* Cadenas ISO/ANSI */
...
const AMAZON_QUERY_BY_ID = /** @type {Record<string, string>} */ ({
  'belt-v-SPZ': 'industrial V-belt SPZ',
  'belt-v-SPA': 'V-belt SPA',
  'belt-v-SPB': 'V-belt SPB',
  'belt-v-SPC': 'V-belt SPC',
  'belt-v-XPZ': 'narrow V-belt XPZ',
  'belt-v-XPA': 'narrow V-belt XPA',
  'belt-v-XPB': 'narrow V-belt XPB',
  'belt-sync-3': 'timing belt HTD 3M',
  'belt-sync-5': 'timing belt HTD 5M',
  'belt-sync-8': 'timing belt HTD 8M',
  'belt-sync-8_at': 'timing belt AT10',
  'belt-sync-14': 'timing belt 14M',
  'belt-sync-2.032': 'timing belt XL pitch',
  'belt-flat-std': 'flat drive belt neoprene',
  'belt-poly-PJ': 'ribbed belt Poly-V PJ',
  'belt-poly-PK': 'ribbed belt Poly-V PK',
  'belt-poly-PL': 'ribbed belt Poly-V PL',
  'belt-poly-PM': 'ribbed belt Poly-V PM',
